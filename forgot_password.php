    ...
    <div class="containerForgot">
        <form id="account_form" method="post" onsubmit="return validateForgotPass()">
            ...
            <div class="form-floating mb-3">
                <input type="text" id="sendEmail" name="sendEmail" class="form-control" placeholder="Enter email address" />
                <label for="text">Enter email address</label>
            </div>
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button type="button" class="btn btn-primary" name="btnSubmit" id="forgot_password" onclick="new Account().forgot_password();">
                    Submit
                </button>
            </div>
        </form>
