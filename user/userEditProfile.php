        ...
        <div class="formContainer">
            ...
            <form action="">
                <div class="left">
                    <div class="leftChild">
                        <div class="imgCont">
                            <img id="imgUpload" class="imgUpload" src="../img/uploadIMG.png" alt="">
                        </div>

                        <div class="input-group mb-3 mt-3">
                            <input type="file" class="form-control" id="imageInput" accept="image/*" onchange="editUserIMG(event)">
                        </div>
                    </div>
                </div>
                <div class="right">
                    <div class="rightChild">
                        ...
                        <input id="addr" type="text" class="text">

                        <label for="uname">Username</label>
                        <input id="uname" type="text" class="text">
                    </div>
                    <div class="btns">
