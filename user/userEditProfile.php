        ...
        <div class="form_">
            ...
            <form id="editProfile_form" method="POST" enctype="multipart/form-data">
                <div class="form_div1">
                    ...
                    <div class="btns">
                        <div class="end">
                            <button class="submitBTN btn" type="button" id="update_profile" onclick="new Account().update_uProfile('other');">Update</button>
                            <button class="backBTN btn" type="button" onclick="window.location.replace('userHome.php');">Back</button>
                        </div>
                    </div>
                ...
                <div class="form_div2">
                    ...
                    <div class="btns">
                        <div class="end">
                            <button class="submitBTN btn" type="button" id="update_username" onclick="new Account().update_uProfile('username');">Update</button>
