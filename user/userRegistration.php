        ...
        <form id="account_form" method="POST">
            ...
            <div class="row">
                ...
                <div class="form-floating mb-3 col-4 gx-2 gy-2">
                    ...
                    <input type="text" id="middleName" name="mName" class="form-control" placeholder="Enter Middle Name">
                ...
                <div class="form-floating mb-3 col-6 gx-2 gy-2">
                    <input type="email" id="emailAddress" name="email" class="form-control" placeholder="Enter Email Address">
                    <label id="eAdd" for="emailAddress">Enter Email Address</label>
                </div>

                <!--For the password we use 6 -->
                <div class="form-floating mb-3 col-6 g-2">
                    <input type="password" id="pass1" name="password" onkeyup="new Account().verify_password(this.value, 'company')" class="form-control" placeholder="Enter Password">
                ...
                <div class="form-floating mb-3 col-6 g-2">
                    <input type="password" id="pass2" class="form-control" name="password2" placeholder="Re-enter Password">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                ...
                <button type="button" id="btnUserReg" class="btn btn-primary" onclick="new Account().user_register();" disabled=true>
                    Register
                </button>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-center">
                    <h1 class="modal-title fs-5 text-primary" id="staticBackdropLabel">Terms and Conditions</h1>
