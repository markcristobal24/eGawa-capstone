    ...
    <div class="containerRegis">
        <form id="account_form" method="POST">
            ...
            <div class="row">
                ...
                <select class="add- mb-3 col-4" name="province" id="provinceDropdown"
                    onchange="updateMunicipalityDropdown()">
                    <option value="">Select Province</option>
                </select>

                <select class="add- mb-3 col-4" name="municipality" id="municipalityDropdown"
                ...
                <div>
                    <input type="checkbox" name="checkboxName" id="checkbox_terms" value="checkboxValue">
                    <label class="resize" for="checkbox_terms"><span id="termsTitle" class="resize">I agree to the
                        </span></label>
