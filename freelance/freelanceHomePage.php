...
<body>
                ...
                ?>
                        <div class="containerPost">
                            ...
                            <div class="containerCatalog">
                                ...
                                <div>
                                    <button type="button" id="viewPostBTN" class="" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="new Catalog().view_catalogs(<?php echo $catalog_id; ?>);">View Portfolio</button>
                                </div>
                            </div>
                        </div>
                <?php
                    ...
                    echo '<p>There is no Portfolio available at the moment. <br> Please add one</p>';
                    echo '</div>';
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body-view-catalog">
                    <div class="containerImg">
                        <img id="catalogImage" src="../img/work2.png" alt="" class="img-fluid">
                    </div>
                    <hr>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Add Portfolio</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body-add">
                    ...
                    <form id="catalog_form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3 col-12 gx-2 gy-2 mx-auto">
                            ...
                            <label id="catalogTitleLabel" for="companyName">Enter Portfolio Title</label>
                        </div>
                        ...
                        <div class="form-floating mb-3 col-12 gx-2 gy-2 mx-auto">
                            ...
                            <label id="catalogDescriptionLabel" for="catalogDescription">Enter Portfolio
                                Description</label>
                        </div>
                        <div class="modal-footer">
                ...
                <div class="modal-body-add">
                    <form id="edit_catalogForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3 col-12 gx-2 gy-2 mx-auto">
                            ...
                            <label id="catalogTitleLabel" for="edit-catalot-title">Enter Portfolio Title</label>
                        </div>
                        ...
                        <div class="form-floating mb-3 col-12 gx-2 gy-2 mx-auto">
                            ...
                            <label id="catalogDescriptionLabel" for="edit-catalog-desc">Enter Portfolio
                                Description</label>
                        </div>
                        <div class="modal-footer">
