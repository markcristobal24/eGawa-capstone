        ...
        <form id="account_form" method="POST">
            ...
            <div class="row">
                ...
                <div class="form-floating mb-3 col-6 g-2">
                    <input type="password" id="pass1" onkeyup="new Account().verify_password(this.value);" name="password" class="form-control" placeholder="Enter Password">
                ...
                <div class="form-floating mb-3 col-6 g-2">
                    <input type="password" id="pass2" name="password2" class="form-control" placeholder="Re-enter Password">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                ...
                <button type="button" id="btnFreelanceReg" class="btn btn-primary" onclick="new Account().registerFreelance();" disabled=true>
                    Register
                </button>
