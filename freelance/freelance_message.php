            ...
            <div class="modal-body">
                <form id="report_form" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="reported_username" placeholder="@JPSulit" disabled>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="report_reason" id="message-text"></textarea>
                    </div>
